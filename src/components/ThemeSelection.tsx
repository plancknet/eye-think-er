          ...
          {themes.map((theme) => {
            ...
            return (
              <button
                ...
                className="group relative p-8 rounded-2xl border-2 border-border hover:border-primary transition-all hover:scale-105 bg-card"
              >
                ...
                <div className="relative space-y-4">
                  <div className="flex justify-center">
                    <div className={`p-6 rounded-full bg-gradient-to-br ${theme.color}`}>
